...
abstract class ShortComponent : Component, Comparable<ShortComponent> {

    abstract var value: Short
    ...
    override operator fun compareTo(other: ShortComponent): Int = value.compareTo(other.value)
